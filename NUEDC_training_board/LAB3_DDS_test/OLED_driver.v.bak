			...
			case(state)
				...
				MAIN:begin
						...
						case(cnt_main)	//MAIN状态
							...
							5'd1:		begin y_p <= 8'hb0; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP"};state <= SCAN; end
							5'd2:		begin y_p <= 8'hb1; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP"};state <= SCAN; end
							5'd3:		begin y_p <= 8'hb2; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP"};state <= SCAN; end
							5'd4:		begin y_p <= 8'hb3; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP"};state <= SCAN; end
                     ...
                     5'd8:		begin y_p <= 8'hb7; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= "                ";state <= SCAN; end
							5'd9:		begin y_p <= 8'hb4; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP"} ;state <= SCAN; end
							5'd10:	begin y_p <= 8'hb5; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP"}   ;state <= SCAN; end
							5'd11:	begin y_p <= 8'hb6; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP"}   ;state <= SCAN; end
                     5'd12:	begin y_p <= 8'hb7; x_ph <= 8'h10; x_pl <= 8'h00; num <= 5'd16; char <= {"ABCDEFGHIJKLMNOP" };state <= SCAN; end
